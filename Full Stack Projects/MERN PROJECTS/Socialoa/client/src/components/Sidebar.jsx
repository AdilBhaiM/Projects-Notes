...
const Sidebar = () => {
  ...
  return (
    ...
    <div className="fixed h-screen flex flex-col card w-[300px] bg-gray-900 p-5 shadow-md shadow-purple-200/50 rounded-md">
      <ul className="w-full flex flex-col gap-2 flex-1">
        ...
        <li className="flex-center cursor-pointer p-16-semibold w-full">
        ...
        <li className="flex-col flex flex-1 cursor-pointer p-16-semibold justify-end w-full whitespace-nowrap">
          <button
            onClick={logout}
            className="flex w-full text-white gap-4 py-3 px-8 font-medium rounded-full bg-cover hover:bg-red-700 hover:shadow-inner focus:bg-red-700 transition-all ease-linear"
          >
            <LogOut />
            Logout
          </button>
